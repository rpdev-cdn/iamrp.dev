...
Windows Server Administration | Active Directory | Microsoft Office 365 | Microsoft Exchange | Linux (Fedora, Debian, Ubuntu) | Vulnerability Management (Nessus) | Endpoint Security | Technical Troubleshooting | IT Procurement & Vendor Management | High Availability (HA) | Database Administration

### Hardware & Electronics
Hardware Diagnostics | Electronics Repair | Embedded Systems | Bare-Metal Hardware Maintenance | Component-Level Repair (TV/Monitors/Printers) | Automotive Diagnostics & Electrical Systems
...
- Architected and administered production and development systems across distributed multi-branch operations, deploying WatchGuard XTM appliances in a high-availability stacked failover cluster and managing SonicWall perimeter VPN tunnels.
- Served as the primary lead for third-party security audits (SOC 2, ISO 27001, ALTA), deploying internal Nessus scanning appliances and scheduled external perimeter scans to maintain a 100% audit pass rate.
...
- Managed high-performance network routing and core HP ProCurve managed switching infrastructure, enforcing Layer 2 Port Security (MAC limiting, sticky learning) and VLAN segmentation across 150+ user workstations.
