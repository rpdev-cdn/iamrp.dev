...
- **Auditing, Compliance & Vulnerability Management:** Served as the primary lead for third-party information security audits (SOC 2, ISO 27001, ALTA), achieving a 100% audit pass rate. Deployed on-premise Nessus internal scanning appliances for credentialed subnet auditing and orchestrated scheduled external Nessus perimeter scans to proactively remediate vulnerabilities and satisfy rigorous client security questionnaires.
...
_PCS Automotive Inc_ | May 2007 – May 2008
...
- **Hardware Lifecycle:** Cataloged, repaired, and prepared donated computer hardware for community deployment and installation.
- **Network Troubleshooting:** Diagnosed and repaired local area network (LAN) and hardware issues for internal staff.
- **Web Maintenance:** Maintained, updated, and modernized the organization's pre-existing website.
