...
<div style="margin: 1.25rem 0 1.75rem 0; display: flex; gap: 0.75rem; flex-wrap: wrap;">
  <a href="https://docingest.iamrp.dev/add" class="di-btn di-btn-primary" style="display: inline-flex; padding: 0.65rem 1.25rem; font-weight: 700; text-decoration: none;">
    Index New Docs (Add) 🚀
  </a>
  <a href="https://docingest.iamrp.dev/view" class="di-btn di-btn-secondary" style="display: inline-flex; padding: 0.65rem 1.25rem; font-weight: 700; text-decoration: none;">
...
* **[DocIngest URL Ingestion ↗](https://docingest.iamrp.dev/add)** (`/homelab-projects/docingest/add` or `/add`)  
...
* **[DocIngest Corpus Viewer ↗](https://docingest.iamrp.dev/view)** (`/homelab-projects/docingest/view` or `/view`)  
