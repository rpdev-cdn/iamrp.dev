...
> - 🗄️ **[[Research-and-Ramblings/Security-and-AI-Research/Vector_Knowledge_and_Telemetry|Vector Knowledge Base & Memory Datastore (dev_memory_main)]]**: 768-dimensional Qdrant cognitive memory and telemetry store.
> - 📡 **[[Research-and-Ramblings/Security-and-AI-Research/Empirical_Telemetry_and_RF_Analysis|Empirical Telemetry & RF Anomaly Modeling]]**: Physical signal propagation modeling, path loss math, and dwell-time anomaly scoring.
...
* **Research Swarm Modules:** Explore [[Research-and-Ramblings/Security-and-AI-Research/DFIR_and_Playbooks|DFIR and Playbooks]], [[Research-and-Ramblings/Security-and-AI-Research/Agents_and_Architecture|Agents and Architecture]], [[Research-and-Ramblings/Security-and-AI-Research/Sources_and_Matrix|Sources and Matrix]].
