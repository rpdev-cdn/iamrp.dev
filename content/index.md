...
- **[[Projects/Current_Environment|Current Fleet Topology]]** <span class="telemetry-badge">LIVE TELEMETRY</span> — *Live hardware inventory across primary nodes (`edge` OpenWrt router, `llmadmin01` GPU AI compute host, and `t430` bare-metal cluster).*
