...
<div style="margin: 1.25rem 0 1.75rem 0; display: flex; gap: 0.75rem; flex-wrap: wrap;">
  <a href="/homelab-projects/docingest/add" class="di-btn di-btn-primary" style="display: inline-flex; padding: 0.65rem 1.25rem; font-weight: 700; text-decoration: none;">
    Index New Docs (Add) 🚀
  </a>
  <a href="/homelab-projects/docingest/view" class="di-btn di-btn-secondary" style="display: inline-flex; padding: 0.65rem 1.25rem; font-weight: 700; text-decoration: none;">
...
* **[[Homelab-Projects/DocIngest/add|DocIngest URL Ingestion]]** (`/homelab-projects/docingest/add` or `/add`)  
...
* **[[Homelab-Projects/DocIngest/view|DocIngest Corpus Viewer]]** (`/homelab-projects/docingest/view` or `/view`)  
